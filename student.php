...
<div class="wrapper">
<div class="logo">
	<a href="index.php"><h1>gvhss cherpulassery</h1></a>
</div>
	...
	<div class="cssmenu">
		<ul>
			...
			<li><a href="about.php"><span>About</span></a></li>
                        <li class="active" class="has-sub"><a href="student.php"><span>Student</span></a></li>
...
$dest="1";
$sql = "SELECT * FROM message WHERE dest='$dest' ORDER BY id ";
...
?>                                              
                                            <p class="para"><lia><?=$row["message"]?></lia></p>
<?php }} ?>
						<div class="button1">
                                                    <a href="temp2.php" class="btn btn_s">Continue to login</a>
						</div>
					</div>
				</div>  
...
<div class="wrapper">
	<div class="footer">
		...
		<a href="index.php"><h2>gvhss cherpulassery</h2></a>
Developed by
                Abhishek S
                mob:9605212743
		<div class="copy">
